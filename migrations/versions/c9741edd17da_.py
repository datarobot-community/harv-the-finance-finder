...
Revision ID: c9741edd17da
Revises: fe92ab5e89a0
Create Date: 2020-05-17 16:50:43.164649
...
revision = 'c9741edd17da'
down_revision = 'fe92ab5e89a0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('initial', sa.Numeric(), nullable=True),
